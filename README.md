### NOTE: This repository's root [has been moved here](https://github.com/rotundasoftware/backbone.courier). Please refer to its new home for the most current documenation and code, and submit your issues and pull requests there.
